...
path_thumos14yaml="STADe-DeepSeg/configs/thumos14.yaml"
absolute_path_thumos14yaml = os.path.join(absolute_path, path_thumos14yaml)

def get_config():
    parser = argparse.ArgumentParser()
    parser.add_argument('config_file', type=str,
                        default=absolute_path_thumos14yaml, nargs='?')
    ...
    parser.add_argument('--lw', type=float, default=6)
    ...
    parser.add_argument('--resume', type=int, default=56)
