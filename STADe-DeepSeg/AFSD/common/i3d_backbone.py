...
class InceptionI3d(nn.Module):
    ...
    def __init__(self, num_classes=400, spatial_squeeze=True,
        ...
        self.end_points[end_point] = MaxPool3dSamePadding(kernel_size=[3, 3, 3], stride=(2, 2, 2), # (2, 2, 2)
                                                          padding=0)
        if self._final_endpoint == end_point:
            return
        ...
        self.end_points[end_point] = MaxPool3dSamePadding(kernel_size=[2, 2, 2], stride=(2, 2, 2), # stride=(2, 2, 2)
                                                          padding=0)
        if self._final_endpoint == end_point:
            return
