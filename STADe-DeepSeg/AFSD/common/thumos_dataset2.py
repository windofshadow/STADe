...
def get_class_index_map(class_info_path='/root/tf-logs/Backbone_I3D-num0-9/thumos_annotations/Class Index_Detection.txt'):
...
def annos_transform(annos, clip_length):
    ...
    for anno in annos:
        ...
        print("lable",anno[2],'lable_type',type(anno[2]),len(annos))
    return res
...
class THUMOS_Dataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # print('input_data.shape',input_data.shape) # [1, 8000, 9, 30]
