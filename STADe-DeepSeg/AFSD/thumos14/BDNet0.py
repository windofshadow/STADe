...
class I3D_BackBone(nn.Module):
    ...
    def load_pretrained_weight(self, model_path='/root/tf-logs/Backbone_I3D-num0-9/models/thumos14/checkpoint-15.ckpt'):
...
class CoarsePyramid(nn.Module):
    def __init__(self, feat_channels, frame_num=8000): # 原为256
    ...
    def forward(self, feat_dict, ssl=False):
        ...
        # print('x1',x1.shape,'x2',x2.shape)  # x1 torch.Size([2, 832, 2000, 1, 2]) x2 torch.Size([2, 1024, 1000, 1, 1])
        batch_num = x1.size(0)
